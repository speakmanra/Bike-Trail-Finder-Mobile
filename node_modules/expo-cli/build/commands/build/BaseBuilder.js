...
`;
  ...
  async ensureReleaseExists() {
    if (this.options.publish) {
      ...
      if (!release) {
        throw new (_BuildError().default)('No releases found. Please create one using `exp publish` first.');
      }
  ...
  async build(expIds) {
    ...
    if (this.options.wait) {
      ...
      (0, _log().default)('Alternatively, run `exp build:status` to monitor it from the command line.');
    }
  }
