...
async function parseStartOptionsAsync(projectDir, options) {
  let startOpts = {};
  ...
  if (options.webOnly) {
    ...
    startOpts.webOnly = await _xdl().Web.onlySupportsWebAsync(projectDir);
  }
...
async function action(projectDir, options) {
  ...
  let rootPath = _path().default.resolve(projectDir);

  let devToolsUrl = await _devTools().DevToolsServer.startAsync(rootPath);
